...
DROP DATABASE IF EXISTS `cs6400_sp22_team064`; 
SET default_storage_engine=InnoDB;
SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE DATABASE IF NOT EXISTS cs6400_sp22_team064 
...
GRANT ALL PRIVILEGES ON `cs6400_sp22_team064`.* TO 'gatechUser'@'localhost';
FLUSH PRIVILEGES;
